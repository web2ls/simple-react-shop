...
const Good = React.createClass({
  ...
  onClickAddToCart: function(goodId, incCount) {
  ...
  render: function() {
    ...
    return(
      <div>
        ...
        <button onClick={this.onClickAddToCart.bind(null, good[0].id, 1)} className='add-to-cart' type="button">Add to Cart</button>
        <br />
